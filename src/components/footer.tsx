          ...
          <div className="grid grid-cols-1 gap-y-10 border-b border-white/10 pb-10 text-left md:grid-cols-4 md:gap-y-0 md:gap-x-8 md:pb-10 lg:gap-x-12">
            ...
            <div className="md:col-span-1">
              ...
              <div className="mt-6 flex gap-2">
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 bg-white/5 text-slate-400 transition-colors hover:border-[#1a6aff]/50 hover:bg-[#1a6aff]/10 hover:text-white" aria-label="Twitter">
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 bg-white/5 text-slate-400 transition-colors hover:border-[#0077b5]/50 hover:bg-[#0077b5]/10 hover:text-white" aria-label="LinkedIn">
